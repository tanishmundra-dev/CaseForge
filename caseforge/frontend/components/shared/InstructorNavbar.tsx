...
import { LogOut, Sparkles, BookOpen, BarChart3, Users } from "lucide-react";

const NAV_ITEMS = [
  { label: "Courses", href: "/instructor/case-studies", icon: BookOpen },
  { label: "Course Generator", href: "/instructor/mission-control", icon: Sparkles },
...
export default function InstructorNavbar() {
  ...
  return (
    <nav style={{
      ...
      {/* Logo */}
      <Link href="/instructor/mission-control" style={{ fontFamily: "var(--font-display)", fontSize: 18, fontWeight: 800, marginRight: 32, display: "flex", alignItems: "center", gap: 2 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
        ...
        <span className="badge badge-accent" style={{ fontSize: 10, padding: "2px 8px" }}>INSTRUCTOR</span>
        <button
          onClick={logout}
